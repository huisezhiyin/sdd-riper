...
这个目录只保留四篇定位互补的长文。历史稿不再放在工作树里；如需追溯，可以从 Git 历史恢复。
...
| [超级个体与个体超级](./super-individual.md) | 对大模型、人才和组织关系感兴趣的读者 | 大模型怎样扩大少数强认知者的能力边界，组织又该如何识别和使用这种人 |
...
如果你想理解大模型对个人能力和组织方式的影响：

1. 读《超级个体与个体超级》；
2. 再读《为什么通用 Agent 是饮鸩止渴》，理解个人能力与工具形态之间的关系。
...
- 长文围绕“核心判断、实践工作法、Agent 产品观点、人才与组织思考”四个位置组织。
