...
It is not a generic chat summary. It should preserve the next agent's operating context: the current goal, workspace, decisions, files, validation evidence, risks, constraints, and the exact next action.
...
4. Write the handoff using `references/handoff-template.md`.
